...
GENESIS_OAM_IP = "135.21.99.139"
GENESIS_CREDS = "jenkins-ssh-key"
GENESIS_NODE = "ss233c-genesis"


def addSlave(ip, port, creds, name, timeout=null, retries=null, waitRetry=null) {
    ...
    agent.nodeDescription = GENESIS_NODE
