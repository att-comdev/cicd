...
def submitCertificatesPatchset(credentials, projectSite, userEmail, userName, commitMessage) {
    sshagent(credentials: [credentials]) {
        sh """
                                ...
                                git push -v ssh://m92484@gerrit.mtn5.cci.att.com:29418/aic-clcp-security-manifests HEAD:refs/for/master
                            """
    }
}
