...
def node_create(String name, String host, String port = '22',
    ...
    withCredentials([usernamePassword(credentialsId: 'jenkins-token',
        ...
        cmd = "keytool -import -alias JENKINS-CONTROLLER-CERT  -keystore myKeystore -file /var/jenkins_home/ca.crt -storepass changeit -noprompt; echo '${config}' | java -Djavax.net.ssl.trustStore=myKeystore -Djavax.net.ssl.trustStorePassword=changeit -jar \$JENKINS_CLI ${opts} create-node ${name}"
