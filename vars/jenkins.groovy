...
def node_create(String name, String host, String port = '22',
    ...
    withCredentials([usernamePassword(credentialsId: 'jenkins-token',
        ...
        cmd = "echo '${config}' | java -Djavax.net.ssl.trustStore=/var/jenkins_home/JenkinsKeystore -Djavax.net.ssl.trustStorePassword=changeit -jar \$JENKINS_CLI ${opts} create-node ${name}"
...
def node_delete(String name) {
    withCredentials([usernamePassword(credentialsId: 'jenkins-token',
        ...
        cmd = "java -Djavax.net.ssl.trustStore=/var/jenkins_home/JenkinsKeystore -Djavax.net.ssl.trustStorePassword=changeit -jar \$JENKINS_CLI $opts delete-node $name"
