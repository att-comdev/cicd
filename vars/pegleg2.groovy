 ...
 * @param projectSite The name of the site you're looking to render. Must match what's in your site repository's site-definition.yaml
 */
def lintWithinContainerNoGlobal(siteRepo, username, sshKey, projectSite) {
 ...
 * @param projectSite The name of the site you're looking to render. Must match what's in your site repository's site-definition.yaml
 */
def renderWithinContainer(siteRepo, username, sshKey, projectSite) {
    sh "pegleg site -p ${siteRepo} -u ${username} -k ${sshKey} render ${projectSite} -o ${projectSite}.yaml"
}
 ...
 * @param projectSite The name of the site you're looking to render. Must match what's in your site repository's site-definition.yaml
 */
def collectWithinContainer(siteRepo, username, sshKey, projectSite) {
    sh "pegleg -v site -r ${siteRepo} -u ${username} -k ${sshKey} collect ${projectSite} -s ${projectSite}"
}
 ...
 * @param projectSite The name of the site you're looking to render. Must match what's in your site repository's site-definition.yaml
 */
def generate(siteRepo, globalRepo, username, sshKey, author, projectSite) {
    sh "docker run --rm -i --net=none --workdir=/workspace -v \$(pwd):/workspace \
        $conf.PEGLEG_IMAGE pegleg.sh -v site -r ${siteRepo} -e global=${globalRepo} -u ${username} -k ${sshKey} secrets generate passphrases ${projectSite} -a ${author} -s /workspace"
}
 ...
 * @param projectSite The name of the site you're looking to render. Must match what's in your site repository's site-definition.yaml
 */
def generateWithinContainer(siteRepo, globalRepo, username, sshKey, author, projectSite) {
    sh "pegleg.sh -v site -r ${siteRepo} -e global=${globalRepo} -u ${username} -k ${sshKey} secrets generate passphrases ${projectSite} -a ${author} -s /workspace"
}