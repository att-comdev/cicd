...
def lintAndPull(tmpPath, siteRepo, username, sshKey, siteName) {
    sh "pegleg -v site -p ${tmpPath} -r ${siteRepoPath} -u ${username} -k ${sshKey} lint ${siteName} -w P001 -w P003"
}
...
def lintAndPull(tmpPath, siteRepo, globalRepo, secretsRepo, username, sshKey, siteName) {
    sh "pegleg -v site -p ${tmpPath} -r ${siteRepoPath} -e global={globalRepo} -e secrets={secretsRepo} -u ${username} -k ${sshKey} lint ${siteName} -w P001 -w P003"
}
