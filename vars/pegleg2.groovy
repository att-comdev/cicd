 ...
 * @param siteName The name of the site you're looking to render. Must match what's in your site repository's site-definition.yaml
 */
def generateGenesisWithinContainer(siteRepo, destinationDirectory, encryptionKey, siteName) {
    sh "pegleg -v site -r ${siteRepo} genesis_bundle -b ${destinationDirectory} -k ${encryptionKey} ${siteName}"
}
