...
def generatePkiWithinContainer(siteRepo, author, siteName, peglegPassphrase, peglegSalt) {
    sh """export PEGLEG_PASSPHRASE="${peglegPassphrase}"; export PEGLEG_SALT="${peglegSalt}"; pegleg -v site -r ${siteRepo} secrets generate-pki -a ${author} ${siteName}"""
}
 ...
 * @param siteName The name of the site you're looking to render. Must match what's in your site repository's site-definition.yaml
 */
def generatePkiWithinContainer(siteRepo, secretsRepo, author, siteName, peglegPassphrase, peglegSalt) {
    sh """export PEGLEG_PASSPHRASE="${peglegPassphrase}"; export PEGLEG_SALT="${peglegSalt}"; pegleg -v site -r ${siteRepo} -e secrets=${secretsRepo} secrets generate-pki -a ${author} ${siteName}"""
}