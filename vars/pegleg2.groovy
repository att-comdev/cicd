 ...
 * @param "directory" for local directory repositories, "url" to override yaml site-definition
 */
def renderWithinContainer(siteRepo, username, sshKey, siteName, type) {
    sh "pegleg site -r ${siteRepo} -u ${username} -k ${sshKey} render ${siteName} -o ${siteName}.yaml"
}
 ...
 * @param "directory" for local directory repositories, "url" to override yaml site-definition
 */
def collectWithinContainer(siteRepo, username, sshKey, siteName, type) {
    sh "pegleg -v site -r ${siteRepo} -u ${username} -k ${sshKey} collect ${siteName} -s ${siteName}"
}
...
def encrypt(siteRepo, globalRepo, username, sshKey, author, siteName) {
    sh "docker run --rm -i --net=none --workdir=/workspace -v \$(pwd):/workspace \
        $conf.PEGLEG_IMAGE pegleg.sh -v site -r ${siteRepo} -e global=${globalRepo} -u ${username} -k ${sshKey} secrets encrypt -a ${author} ${siteName}"
}
...
def encryptWithinContainer(siteRepo, globalRepo, username, sshKey, author, siteName) {
    sh "pegleg.sh -v site -r ${siteRepo} -e global=${globalRepo} -u ${username} -k ${sshKey} secrets encrypt -a ${author} ${siteName}"
}
 ...
 * @param siteName The name of the site you're looking to render. Must match what's in your site repository's site-definition.yaml
 */
def encrypt(siteRepo, username, sshKey, author, siteName, peglegPassphrase, peglegSalt) {
    sh "docker run --rm -i --net=none --workdir=/workspace -v \$(pwd):/workspace \
        -e "PEGLEG_PASSPHRASE=${peglegPassphrase}" -e "PEGLEG_SALT=${peglegSalt}" $conf.PEGLEG_IMAGE -e pegleg.sh -v site -r ${siteRepo} -u ${username} -k ${sshKey} secrets encrypt -a ${author} ${siteName} PEGLEG_PASSPHRASE=${peglegPassphrase} PEGLEG_SALT=${peglegSalt}"
}
 ...
 * @param siteName The name of the site you're looking to render. Must match what's in your site repository's site-definition.yaml
 */
def encryptWithinContainer(siteRepo, username, sshKey, author, siteName, passphrase, salt) {
    sh """PEGLEG_PASSPHRASE="${peglegPassphrase}"; PEGLEG_SALT="${peglegSalt}"; pegleg.sh -v site -r ${siteRepo} -u ${username} -k ${sshKey} secrets encrypt -a ${author} ${siteName}"""
}
...
def generatePki(siteRepo, globalRepo, username, sshKey, author, siteName) {
    sh "docker run --rm -i --net=none --workdir=/workspace -v \$(pwd):/workspace \
        $conf.PEGLEG_IMAGE pegleg.sh -v site -r ${siteRepo} -e global=${globalRepo} -u ${username} -k ${sshKey} secrets generate-pki -a ${author} ${siteName}"
}
 ...
 * @param siteName The name of the site you're looking to render. Must match what's in your site repository's site-definition.yaml
 */
def generatePkiWithinContainer(siteRepo, globalRepo, username, sshKey, author, siteName) {
    sh "pegleg.sh -v site -r ${siteRepo} -e global=${globalRepo} -u ${username} -k ${sshKey} secrets generate-pki -a ${author} ${siteName}"
}
 ...
 * @param siteName The name of the site you're looking to render. Must match what's in your site repository's site-definition.yaml
 */
def generatePki(siteRepo, username, sshKey, author, siteName) {
    sh "docker run --rm -i --net=none --workdir=/workspace -v \$(pwd):/workspace \
        $conf.PEGLEG_IMAGE pegleg.sh -v site -r ${siteRepo} -u ${username} -k ${sshKey} secrets generate-pki -a ${author} ${siteName}"
}
 ...
 * @param siteName The name of the site you're looking to render. Must match what's in your site repository's site-definition.yaml
 */
def generatePkiWithinContainer(siteRepo, username, sshKey, author, siteName) {
    sh "pegleg.sh -v site -r ${siteRepo} -u ${username} -k ${sshKey} secrets generate-pki -a ${author} ${siteName}"
}