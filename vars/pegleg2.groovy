...
def lintWithinContainer(site, siteRepo, username, ssh_key) {
  sh "pegleg -v site -r ${siteRepo} -e global=ssh://REPO_USERNAME@gerrit.mtn5.cci.att.com:29418/aic-clcp-manifests@refs/changes/31/53331/1 -u ${username} -k ${ssh_key} lint ${site} -x P001 -x P003"
}
