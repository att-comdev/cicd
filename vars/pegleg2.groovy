 ...
 * @param projectSite The name of the site you're looking to render. Must match what's in your site repository's site-definition.yaml
 */
def lintWithinContainer(siteRepo, globalRepo, username, sshKey, projectSite) {
  sh "pegleg -v site -r ${siteRepo}  -e global=${globalRepo} -u ${username} -k ${sshKey} lint ${projectSite} -x P001 -x P003"
}
