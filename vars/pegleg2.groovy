 ...
 * @param secretsRepo The folder container your security documents (must be at your PWD)
 */
def lintWithinContainer(site, siteRepo, username, ssh_key, gerritRefspec = "refs/for/master") {
  sh "pegleg -v site -r ${siteRepo} -e global=ssh://REPO_USERNAME@gerrit.mtn5.cci.att.com:29418/aic-clcp-manifests@${gerritRefspec} -u ${username} -k ${ssh_key} lint ${site} -x P001 -x P003"
}
