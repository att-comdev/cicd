...
def lintWithinContainer(site, siteRepo, username, ssh_key) {
  sh "pegleg -v site -r ${siteRepo} -e global=ssh://REPO_USERNAME@gerrit.mtn5.cci.att.com:29418/aic-clcp-manifests@26b8d3e183f280c06b80eef45ea7dbde9763630c -u ${username} -k ${ssh_key} lint ${site} -x P001 -x P003"
}
