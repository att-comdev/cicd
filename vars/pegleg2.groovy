 ...
 * @param secretsRepo The folder container your security documents (must be at your PWD)
 */
def lintWithinContainer(site, siteRepo, username, ssh_key) {
  sh "pegleg -v site -r ${siteRepo} -e global=ssh://REPO_USERNAME@gerrit.mtn5.cci.att.com:29418/aic-clcp-manifests@Idfadc06a430935997761a7ef94060bb8d2136c98 -u ${username} -k ${ssh_key} lint ${site} -x P001 -x P003"
}
