...
def renderWithinContainer(siteRepo, globalRepo, secretsRepo, username, sshKey, siteName, type) {
  if (type == "directory"){
    ...
    sh "pegleg site -p ${siteRepo} -e global=${globalRepo} -u ${username} -k ${sshKey} render ${siteName} -o ${siteName}.yaml"
  }
}
...
def renderWithinContainer(siteRepo, username, sshKey, siteName, type) {
    sh "pegleg site -p ${siteRepo} -u ${username} -k ${sshKey} render ${siteName} -o ${siteName}.yaml"
}
