 ...
 */
def runDind(String dockerImage, String artifactoryURL, String artifactoryCred, String containerName) {
 ...
 */
def runNginx(String containerName, String nginxImage, String localPort) {
    sh "mkdir -p web"
