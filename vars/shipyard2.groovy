 ...
 * @param withCreds Boolean. Flag for using jenkins configuration to get keystone credentials.
 */
def waitAction(actionID, shipyardUrl, keystoneCredId, keystoneUrl, withCreds=true) {

    action = _getAction(actionID, shipyardUrl, keystoneCredId, keystoneUrl, withCreds=true)
