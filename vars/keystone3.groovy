...
def token(Map map) {
    ...
    map.keystoneCreds.any {
        ...
        if(map.containsKey('keystoneUserDomain')
            && map.containsKey('keystoneProjectDomain')
            && map.containsKey('keystoneProject')) {
                req = ["auth": [
                         "identity": [
                           "methods": ["password"],
                           "password": [
                             "user": ["name": map.keystoneUser,
                                      "domain": ["name": map.keystoneUserDomain],
                                      "password": map.keystonePassword ]]],
                         "scope": [
                           "project": ["name": map.keystoneProject,
                                       "domain": ["name": map.keystoneProjectDomain]]]]]
        }
