...
pipelineJob("images/base-images/docker-brew-ubuntu-core-xenial") {
    parameters {
        stringParam {
...
pipelineJob("images/base-images/buildpack-deps-xenial-curl") {
    parameters {
        stringParam {
...
pipelineJob("images/base-images/buildpack-deps-xenial-scm") {
    parameters {
        stringParam {
...
pipelineJob("images/base-images/buildpack-deps-xenial") {
    parameters {
        stringParam {
...
pipelineJob("images/base-images/python-3.5-xenial") {
    parameters {
        stringParam {
...
pipelineJob("images/base-images/python-3.6-xenial") {
    parameters {
        stringParam {
